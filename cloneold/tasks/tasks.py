...
class TaskManager(BaseModel):
    ...
    def generate_task_plan(self, thoughts: str, retries=5, delay=5):
        """Generate a task plan for the agent."""      
        BASE_TEMPLATE = """
        You are an autonomous cognitive agent named Buddy.
        You must generate a task list :
        ...
        [RESPONSE]
        """
        chat_input = BASE_TEMPLATE.format(thoughts=thoughts)
